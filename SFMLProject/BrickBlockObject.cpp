...
void BrickBlockObject::OnCollisionEnter(Collider* target)
{
	...
	//	Rectangle rect(collider->GetPosition(), collider->GetScale(), collider->GetOrigins());
	//	Rectangle targetRect(targetPosition, target->GetScale(), target->GetOrigins());
	//	// targetRect.bottomPosition += target->GetScale().y * 0.5f;
	//	// targetRect.topPosition -= target->GetScale().y * 0.5f;
...
void BrickBlockObject::OnCollisionStay(Collider* target)
{
	...
	//	Rectangle rect(collider->GetPosition(), collider->GetScale(), collider->GetOrigins());
	//	Rectangle targetRect(target->GetPosition(), target->GetScale(), target->GetOrigins());
